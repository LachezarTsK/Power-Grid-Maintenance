...
var processQueries = function (numberOfPowerStations, connections, queries) {
    const operationalStations = new Array(numberOfPowerStations + 1).fill(true);
    ...
    const parentToOperationalStations = createParentToOperationalStations(unionFind, operationalStations, numberOfPowerStations);
 ...
 * @param {boolean[]} operationalStations 
 * @param {number} numberOfPowerStations
 * @return {Map<Integer, OperationalStations> []}
 */
function createParentToOperationalStations(unionFind, operationalStations, numberOfPowerStations) {
...
class OperationalStations {
     ...
     * @param {boolean[]} operationalStations
     */
    constructor(operationalStations) {
        this.operationalStations = operationalStations;
        // PriorityQueue<number>
        this.minHeapForStationID = new PriorityQueue((x, y) => x - y);
    }
    /**
